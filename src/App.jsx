  ...
  <div className="max-w-4xl mx-auto px-4">
    <div className="py-12">
      <h2 className="text-4xl font-bold mb-6 text-center bg-gradient-to-r from-blue-400 to-pink-400 bg-clip-text text-transparent">
        บริการรับทำเว็บไซต์ VTuber
      </h2>
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg space-y-8 mb-8">
        <p className="text-gray-600">
          บริการพัฒนาเว็บไซต์ระดับมืออาชีพสำหรับครีเอเตอร์ VTuber เอเจนซี่ และโปรเจกต์แฟนคลับ
        </p>

        <div className="space-y-8">
          <h3 className="text-2xl font-semibold text-blue-400">💻 แพ็กเกจเว็บไซต์</h3>

          <div className="space-y-6">
            {/* Tier 1 */}
            <div>
              <h4 className="text-xl font-semibold mb-2">🔹 แพ็กเกจพื้นฐาน – 5,000 บาทขึ้นไป</h4>
              <p className="text-gray-600 mb-2">เหมาะสำหรับพอร์ตโฟลิโอ VTuber ส่วนตัว หรือแลนดิ้งเพจแบบง่าย</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>เว็บไซต์หน้าเดียวพร้อมการออกแบบที่ตอบสนองต่อทุกอุปกรณ์</li>
                <li>การปรับแต่งสไตล์ให้เข้ากับแบรนด์ของคุณ</li>
                <li>ลิงก์ติดต่อและโซเชียลมีเดีย</li>
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปี)</li>
              </ul>
              <p className="mt-2">
                ดูตัวอย่าง <a href="https://commission.nephele.in.th/example/tier-1" className="text-blue-500 hover:underline">คลิกที่นี่</a>
              </p>
            </div>

            {/* Tier 2 */}
            <div>
              <h4 className="text-xl font-semibold mb-2">🔹 แพ็กเกจมาตรฐาน – 12,000 บาทขึ้นไป</h4>
              <p className="text-gray-600 mb-2">เหมาะสำหรับเอเจนซี่ VTuber, VTuber อินดี้ หรือโปรเจกต์แฟนคลับ</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>เว็บไซต์หลายหน้า (หน้าแรก, เกี่ยวกับ, ตารางเวลา, แกลเลอรี, ติดต่อ)</li>
                <li>ธีมและการสร้างแบรนด์แบบกำหนดเอง</li>
                <li>เอฟเฟกต์แอนิเมชั่นพื้นฐาน</li>
                <li>การฝังสตรีม Twitch/YouTube</li>
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปี)</li>
              </ul>
              <p className="mt-2">
                ดูตัวอย่าง <a href="https://nirvana-birthday-2025.nephele.in.th" className="text-blue-500 hover:underline">คลิกที่นี่</a>
              </p>
            </div>

            {/* Tier 3 */}
            <div>
              <h4 className="text-xl font-semibold mb-2">🔹 แพ็กเกจพรีเมียม – 25,000 บาทขึ้นไป</h4>
              <p className="text-gray-600 mb-2">สำหรับ VTuber และเอเจนซี่ที่ต้องการเว็บไซต์ระดับไฮเอนด์</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>เว็บไซต์ที่ปรับแต่งได้อย่างเต็มที่</li>
                <li>เรียก API (เช่น ดึงวีดีโอล่าสุดจาก YouTube, ขึ้น Popup เมื่อไลฟ์บน Twitch เป็นต้น)</li>
                <li>การตั้งค่า E-commerce</li>
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปี)</li>
              </ul>
              <p className="mt-2">
                ดูตัวอย่าง <a href="https://commission.nephele.in.th/example/tier-3" className="text-blue-500 hover:underline">คลิกที่นี่</a>
              </p>
            </div>

            {/* Custom Development */}
            <div>
              <h4 className="text-xl font-semibold mb-2">🔹 การพัฒนาแบบกำหนดเอง – เริ่มต้นที่ 30,000 บาท</h4>
              <p className="text-gray-600 mb-2">สำหรับผู้ที่ต้องการคุณสมบัติเว็บไซต์ที่ไม่เหมือนใคร</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>ระบบที่สร้างขึ้นตามความต้องการ</li>
                <li>ระบบแบ็กเอนด์ที่ซับซ้อน</li>
                <li>Setup Domain และ Hosting ให้ (1,500 บาทต่อปี)</li>
              </ul>
              <p className="mt-2">
                ดูตัวอย่าง <a href="https://commission.nephele.in.th/example/tier-custom" className="text-blue-500 hover:underline">คลิกที่นี่</a>
              </p>
            </div>
          </div>
          ...
          {/* Additional Services */}
          <div>
            <h3 className="text-2xl font-semibold text-blue-400 mb-4">🛠️ บริการเสริม</h3>
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>Maintenance และอัปเดตเว็บไซต์ – 3,000 บาท/ปี</li>
              <li>เร่งงาน (เสร็จภายใน 5-7 วัน) – +50% จากราคา</li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h3 className="text-2xl font-semibold text-blue-400 mb-4">📩 ติดต่อสำหรับคอมมิชชั่น</h3>
            <ul className="space-y-2">
              <li className="flex items-center">
                <MessageCircle className="w-5 h-5 text-pink-400 mr-2" />
                <span>อีเมล: <a href="mailto:contact@commission.nephele.in.th" className="text-blue-500 hover:underline">contact@commission.nephele.in.th</a></span>
              </li>
              <li className="flex items-center">
                <MessageCircle className="w-5 h-5 text-pink-400 mr-2" />
                <span>Discord: <a href="https://discord.gg/sMUn5ESwPV" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">เข้าร่วมเซิร์ฟเวอร์</a></span>
              </li>
            </ul>
          </div>
        </div>
